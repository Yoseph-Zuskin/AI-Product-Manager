...
subtypes_of:
- { type: Software Product, resource: <https://www.github.com/Yoseph-Zuskin/okf-abstracts/entities/domain/software-product.md>, version: v0.1.0 }
...
- platform
- system-architecture
- engineeringstatus: stable
stale_after: 2027-08-19
---
# Software System

A cohesive software product or platform composed of interrelated components thatwork together to fulfill a set ofrequirements.
