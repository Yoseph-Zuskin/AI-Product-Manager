...
subtypes_of:
- { type: Process, resource: <https://www.github.com/Yoseph-Zuskin/okf-abstracts/entities/core/process.md>, version: v0.1.0 }
...
The end-to-end process for planning, creating, testing, deploying, andmaintaining software applications.
