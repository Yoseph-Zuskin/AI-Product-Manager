...
Strategic planning framework used in the Kellogg AI-Driven Product Strategy program, standing for Vision, Values, Methods, Obstacles, and Measures.
...
- Used alongside the Product Strategy Canvas for layering down from vision through arenas, bets, and competencies
- Described in Module 1 (Product Vision, Strategy and Leadership) of the program
