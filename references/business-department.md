...
subtypes_of:
- { type: Organization, resource: <https://www.github.com/Yoseph-Zuskin/okf-abstracts/entities/core/organization.md>, version: v0.1.0 }
...
- department
- functional-unit
- enterprisestatus: stable
stale_after: 2027-08-19
---
# Business Department

A functional unit within an organization responsible for a specific area ofbusiness operations.
