...
Customer lifecycle framework mapping customer jobs across six lifecycle stages, as taught in the Kellogg AI Strategies for Business Transformation program.
...
- Used in AI Strategies program to align AI use cases across demand generation, sales enablement, and service & retention
- The consistent pattern is a three-step drill: define the stage/process, state the job to be done, then attach AI use cases
