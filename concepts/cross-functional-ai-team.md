...
AI product development requires a team topology that spans business, engineering, data, design, and compliance — each with distinct incentives, vocabularies, and cadences. This concept defines the team topology, collaboration rhythms, and decision rights for effective AI product development.
...
| **Business Stakeholder** | Business Department (Sales, Marketing, Finance, Operations) | Buyer Persona / Decision Maker | Business requirements, success metrics, go-to-market alignment |

[^r-business-department][^r-persona]

## Team Topologies (per Team Topologies framework)
...
| **Complicated-Subsystem Team** | Deep ML research, custom model architectures, novel algorithms | Core IP differentiation, research-heavy |

[^r-business-department][^r-software-development-lifecycle]
...
| Quarterly | Strategy & Architecture | PM, Tech Lead, Architect, Business Lead | Roadmap, tech debt, capability investment |

[^r-software-development-lifecycle][^r-business-department]

## Decision Rights (RACI)

| Decision | PM | MLE/DS | Eng Lead | Compliance | Business Stakeholder |
|----------|----|--------|----------|------------|---------------------|
| Problem definition & success metrics | **A** | C | C | I | **R** |
| ML paradigm / algorithm selection | A | **R** | C | I | I |
| Architecture pattern / infra | A | C | **R** | C | I |
| Data access / privacy | A | C | C | **R** | I |
| Model promotion (staging→prod) | A | **R** | C | **R** | I |
| Go-to-market / pricing | **R** | I | I | I | **A** |
| Retirement / sunsetting | **R** | C | C | C | **A** |
