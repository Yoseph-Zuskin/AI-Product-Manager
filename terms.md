# AI Product Manager Plugin Terms of Service
...
By installing and using the AI Product Manager Codex plugin, you agree to these Terms of Service. If you do not agree, do not install or use the plugin.

## License

The AI Product Manager plugin (code, skills, knowledge bundle, templates) is licensed under the **MIT License**. See the [LICENSE](LICENSE) file for full terms.
...
- Use the knowledge bundle concepts in your own product work
...
- Redistribute the original copyrighted Kellogg/Emeritus course materials (these are for personal educational use only per the Emeritus terms of service)
...
IN NO EVENT SHALL THE AUTHORS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR BUSINESS OPPORTUNITIES, ARISING FROM USE OF THE PLUGIN.

## Data & Privacy

See [Privacy Policy](privacy.md) for data handling practices.

## Termination

These terms terminate automatically if you breach them. Upon termination, you must cease use and destroy all copies of the plugin.
...
These terms may be updated. Continued use after changes constitutes acceptance. Check the repository for the current version.
